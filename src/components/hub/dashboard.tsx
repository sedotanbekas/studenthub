...
import { pctText } from "@/lib/frontend/school-chart-rules";
import type { Row } from "@/lib/frontend/types";
import { useHub } from "./context";
import { SchoolCharts } from "./dashboard-charts";
import { Icon } from "./icon";
import { SponsorHome } from "./sponsor/sponsor-home";

/** Beranda non-siswa: sponsor punya beranda sendiri; admin sekolah & super admin memakai ringkasan di bawah. */
export function Dashboard() {
  const { me } = useHub();
  return me.user.role === "SPONSOR" ? <SponsorHome /> : <AdminDashboard />;
}
